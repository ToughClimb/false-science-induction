...
def main() -> int:
    config_path = parse_config_arg("Generate B73 standard-screen and feedback-triage figure.")
    cfg = load_json_config(config_path)
    require_keys(cfg, REQUIRED_CONFIG_KEYS, "b73_standard_screen_triage_figure")
    configure_style()
