...
from false_science.plot_style import apply_paper_style, set_panel_title, style_axis  # noqa: E402
...
def main() -> int:
    ...
    axes[0].set_ylabel("final target-region acquisitions")
    set_panel_title(axes[0], "a  External CAMEO replay")
    style_axis(axes[0])
    ...
    set_panel_title(axes[1], "b  Pursuit trajectory")
    ...
    fig.suptitle(subtitle, fontsize=8.5, y=1.05)
